...
/**
 * _puts -this writes a string to standard output
...
/**
 * _strdup - this returns pointer to new mem alloc space which contains copy
 ...
 * Return: this returns 0 if it succeeds, and anything else is a failure
 */
